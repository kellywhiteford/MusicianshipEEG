classdef Violin < handle
    ...
    methods
            ...
            switch args.DataStyle
                case 'scatter'
                    if ~isempty(data2)
                        ...
                        obj.ScatterPlot = ... % MarkerEdgeColor added by KLW
                            scatter(pos + jitter.*jitterstrength, data, args.MarkerSize, 'filled','MarkerEdgeColor','black'); 
                ...
                switch args.HalfViolin
                    ...
                    case 'full'
                        obj.ViolinPlot =  ... % plot color will be overwritten later
                            ...
                            [value value(end:-1:1)], [1 1 1],'LineStyle','-','LineWidth',.75); % KLW edited LineWidth
                end
            else
        ...
        function set.ViolinAlpha(obj, alpha)
            ...
            %obj.ScatterPlot.MarkerFaceAlpha = alpha{1}; % modified by KLW
