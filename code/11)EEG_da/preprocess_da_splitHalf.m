...
for uni = 1:length(siteNames)
    ...
    for s = 1:size(subj,2)
        ...
        load(subj_file{s});
        output_file_sCzmod = strcat('../da_Preprocessed_sCz/da_',subj{s},'_sCz.mat');
